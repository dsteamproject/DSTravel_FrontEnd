<template>
  <div class="app">
    <div
      class="bg1"
      :style="{
        backgroundImage: 'url(' + this.tdsave1.total[0][0].firstimage + ')',
      }"
    >
      <div class="bg1_in">
    ...
    <div class="bg2">
      <div class="bg2_in">
        <div class="dech1">
          <span class="sub">작성자 : {{ this.list.member.nicname }}</span>
        </div>
        <span class="sub"></span>
        <div class="dech2"></div>
      </div>
...
export default {
  ...
  methods: {
    async refresh() {
      const url = `/REST/board/selectone?no=${this.no}&category=TDsave`;
