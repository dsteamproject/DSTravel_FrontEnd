    ...
    <div>
        ...
        <div class="wrap">
            <div class="left1">
                ...
                <img src="../assets/seoul9.jpg" class="zoomimg" @click="showMultiple" />
                </div>
                <img src="../assets/seoul1.jpg" class="img2" @click="showMultiple2" />
                 <img src="../assets/seoul2.jpg" class="img2 cimg" @click="showMultiple3" />
                ...
                <div class="staychoice">
                    <div class="cho1">
                        ...
                        <ul class="info">
                            ...
                            <li>기본 객실부터 욕조 구비! 여행의 피로를 싹 풀어보세요! (단, 트리플 객실 제외)</li>
                            <li> 이중섭거리, 매일올레시장 도보 5분 거리!</li>
                        
                        </ul>
                <div class="hr"></div>
                          <label>체크인/체크아웃</label><span>
체크인 - 15:00 / 체크아웃 - 11:00</span>
                              <div class="hr"></div>
                              <label class="label3">환불규정</label>
                              <span class="cancel">취소 및 환불 규정<br>
- 체크인 7일 전 : 취소 수수료 없음<br>
- 체크인 2일 전 : 취소 수수료 50%<br>
- 체크인 당일 : 취소 수수료 100%<br>
<br>
- 취소요청 이후에는 취소의 철회가 불가능합니다.<br>
- 구매당일 취소시에도 환불 규정에 따라 취소 수수료가 부과됩니다.</span>
                    </div>
                </div>
                <div class="staysub">
