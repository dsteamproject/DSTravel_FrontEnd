<template>
   ...
   <div class="tableheader">
       <div class="cell">
   <button class="btn1" @click="toggleAllSelection([tableData])">전체선택</button>
  ...
  >
    ...
    <el-table-column prop="regdate2" label="작성일" width="120"   sortable />
    <el-table-column prop="category" label="카테고리" width="120"   sortable>
      <template #default="scope">{{ scope.row.category }}</template>
    </el-table-column>
    <el-table-column property="title" label="글제목" width="240" sortable />
    <el-table-column property="writer" label="작성자" show-overflow-tooltip  sortable/>
...
import axios from "axios";
  ...
  async created(){
      ...
      this.list = response.data.myboardlist
